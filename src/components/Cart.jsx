...
import { hideCart } from '../redux/store';
...
function Cart() {
  ...
  const cartIsHidden = cartState.isHidden
  ...
  return (
    <div id="cart-container" className={"fixed top-0 right-0 z-40 h-screen p-3 overflow-y-auto transition-transform " + (!cartIsHidden ? "" :"invisible")} tabIndex="-1" aria-labelledby="drawer-label">
      <div id="drawer-label" className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-900 dark:text-gray-100 inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400">
        ...
        <div className="flex justify-end space-x-4">
          <button onClick={() => dispatch(hideCart())} type="button" className="px-6 py-2 border rounded-md dark:border-violet-400" data-drawer-hide="cart-container">Back
